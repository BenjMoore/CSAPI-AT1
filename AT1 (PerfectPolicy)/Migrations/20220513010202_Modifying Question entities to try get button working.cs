...
{
    public partial class ModifyingQuestionentitiestotrygetbuttonworking : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Steve", new DateTime(2022, 5, 13, 11, 2, 2, 30, DateTimeKind.Local).AddTicks(101), 12, "QuizTime", "Quiz" },
                    { 2, "Hank", new DateTime(2022, 5, 13, 11, 2, 2, 30, DateTimeKind.Local).AddTicks(7752), 60, "QuizzyTime", "Yes" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "TUE", "QUIZTIMETEXT", "QuizTime", 1 });

            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "QuestionID", "QuestionImage", "QuestionText", "QuestionTopic", "QuizID" },
                values: new object[] { 2, "TUE", "QuizzyTime", "QuizzyTime", 2 });
