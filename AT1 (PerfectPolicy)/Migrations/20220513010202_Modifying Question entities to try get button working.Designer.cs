...
namespace AT1__PerfectPolicy_.Migrations
{
    ...
    [Migration("20220513010202_Modifying Question entities to try get button working")]
    partial class ModifyingQuestionentitiestotrygetbuttonworking
    {
            ...
            modelBuilder.Entity("AT1__PerfectPolicy_.Models.Quiz", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            QuizID = 1,
                            Creator = "Steve",
                            DateCreated = new DateTime(2022, 5, 13, 11, 2, 2, 30, DateTimeKind.Local).AddTicks(101),
                        ...
                        new
                        {
                            QuizID = 2,
                            Creator = "Hank",
                            DateCreated = new DateTime(2022, 5, 13, 11, 2, 2, 30, DateTimeKind.Local).AddTicks(7752),
