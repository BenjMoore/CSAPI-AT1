...
namespace AT1__PerfectPolicy_.Controllers
{
    ...
    public class QuestionController : ControllerBase
    {
        ...
        /// <summary>
        /// A full list of all created questions
        /// </summary>
        /// <returns></returns>
        [HttpGet]        
        public IEnumerable<Question> Get()
        {
            return _context.Questions.Include(c => c.quiz);
        }
        ...
        /// <returns>A list of questions that relate to the provided Quiz ID</returns>
        [HttpGet]
        [Route("QuestionsForQuizTitle")]

        public ActionResult QuestionsForQuizTitle(int id)
        {

            return Ok(_context.Questions.Where(c => c.QuizID == id).Include(c => c.quiz));
        }
