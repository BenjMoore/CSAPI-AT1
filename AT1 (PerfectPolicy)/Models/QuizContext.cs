   ...
   public QuizContext(DbContextOptions options) : base(options)
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Question>().HasData(
            new Question { QuestionID = 1, QuestionTopic = "QuizTime", QuestionText = "QUIZTIMETEXT", QuestionImage = "TUE", QuizID = 1 },
            new Question { QuestionID = 2, QuestionTopic = "QuizzyTime", QuestionText = "QuizzyTime", QuestionImage = "TUE", QuizID = 2 }
    );
